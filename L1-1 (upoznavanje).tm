...
<\body>
  <screens|<\hidden>
    ...
    <\padded-center>
      <tabular|<tformat|<cwith|1|1|3|3|cell-row-span|3>|<cwith|1|1|3|3|cell-col-span|1>|<cwith|1|1|3|3|cell-valign|c>|<cwith|1|3|1|-1|cell-background|#faa>|<cwith|4|4|1|-1|cell-background|#aaf>|<cwith|5|5|1|-1|cell-background|#afa>|<table|<row|<cell|Kolokvijum
      I>|<cell|K1>|<cell|Z>|<cell|15 bodova>>|<row|<cell|Kolokvijum
      II>|<cell|K2>|<cell|>|<cell|15 bodova>>|<row|<cell|Pismeni
      ispit>|<cell|P>|<cell|>|<cell|40 bodova>>|<row|<cell|Usmeni
      ispit>|<cell|>|<cell|U>|<cell|30 bodova>>|<row|<cell|Dodatni
      bodovi>|<cell|>|<cell|D>|<cell|10 bodova>>>>>
    </padded-center>

    \;

    Kolokvijumi i pismeni ispit se smatraju poloºenim ukoliko kandidat osvoji
    minimalno 50% bodova, odnosno 7.5 bodova po kolokvijumu i 20 bodova na
    pismenom ispitu.

    Obavezni delovi ispita su PISMENI i USMENI ISPIT, kolokvijumi i dodatni
    bodovi nisu obavezni. Mežutim <text-dots>

    <strong|Uslovi za potpis.> Da bi ostvario pravo na potpis, odnosno da bi
    ostvario pravo na polaganje ispita, svaki kandidat mora osvojiti
    minimalno 3 boda po kolokvijumu.
    ...
    <\itemize>
      ...
      7.5 bodova. Bodovi ostvareni na kolokvijumu (bez obzira da li je
      kandidat kolokvijum poloºio ili ne) smatraju se predispitnim obavezama
      i shodno tome vaºe dve ²kolske godine.

      <item>Pismeni ispit se smatra poloºenim ukoliko se na njemu ostvari 20
      ili vi²e bodova. Pismeni ispit vaºi dva roka: rok u kome je ispit
      poloºen i prvi naredni ispitni rok (ra£unaju¢i tu i sve eventualne
      dodatne i vanredne rokove).
    ...
    <\itemize>
      ...
      <\equation*>
        Z=<around*|(|K1+K2-15|)>*\<times\><frac|4|3> + 50
      </equation*>
      ...
      upisati ocenu spram osvojenog broja bodova, bez polaganja usmenog
      ispita. Izuzetno, ukoliko student poloºi oba kolokvijuma sa minimalnih
    ...
    Mili¢ R. Stoji¢. Kontinualni sistemi automatskog upravljanja
  </hidden>>
</body>
